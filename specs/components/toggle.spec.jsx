...
import Toggle from '../../src/components/checkbox/checkbox';
...
describe('A Toggle', () => {
  ...
  it('should have a checkbox class.', () => {
    const wrapper = shallow(<Toggle label={label} theme={theme} checked={true} />);
  ...
  //   };
  //
  //   const wrapper = shallow(<Toggle label={label} theme={checkedTheme} checked={true} disabled />);
  //
  ...
  //     disabled: uniqueid(),
  //   };
  //   const wrapper = shallow(<Toggle label={label} theme={uncheckedTheme} checked={false} disabled />);
  //
  ...
  //     disabled: uniqueid(),
  //   };
  //   const wrapper = shallow(<Toggle label={label} theme={mixedTheme} checked='mixed' disabled />);
  //
  ...
  //     const wrapper = shallow(<Toggle theme={theme} mod="mod1" checked={true} />);
  //     expect(wrapper.hasClass(theme.mod1)).to.be.true;
  //   });
  //
  //   it('should support an array of mods.', () => {
  //     const wrapper = shallow(<Toggle theme={theme} mod={['mod1', 'mod2']} checked={true} />);
  //     expect(wrapper.hasClass(theme.mod1)).to.be.true;
